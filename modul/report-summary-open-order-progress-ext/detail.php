...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="report-summary-open-order-progress-ext/style.css">
</head>
<body>
    <div class="container">
        <!-- Filter Section -->
        <div class="filter-section">
            <form method="GET" class="filter-form">
                <input type="text" name="module" value="report-summary-open-order-progress-ext" hidden>
        ...
        <table id="reportTable">
            <tr>
                <td rowspan="5" style="width: 10%; text-align: center; font-size: 45px; font-weight: bold;">EXT</td>
                <td align="right" style="width: 50%; font-size: 20px; font-weight: 600; background: #000; color: #fff;">Summary Open Order Progress (EXT) for :</td>
